...
export function MobileNavigation({ onAuthClick, onCartClick }: MobileNavigationProps = {}) {
          ...
          if (item.onClick) {
            return (
              <button 
                ...
                className={`relative flex flex-col items-center justify-center p-3 min-w-[64px] touch-feedback transition-all duration-200 ${
                  item.active 
                    ? 'text-brand-orange' 
